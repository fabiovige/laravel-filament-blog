...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | As linhas de linguagem a seguir contêm as mensagens de erro padrão usadas pela
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'O :attribute fornecido apareceu em um vazamento de dados. Por favor, escolha um diferente :attribute.',
    ],
